...
must_haves:
  truths:
    ...
    - "User can sign up with Google OAuth (if enabled)"
...
5. Test onboarding: /onboarding -> create org -> redirect to /dashboard
6. Test OAuth button visibility based on VITE_GOOGLE_OAUTH_ENABLED
7. Test logout from user menu -> redirect to /login
</verification>
