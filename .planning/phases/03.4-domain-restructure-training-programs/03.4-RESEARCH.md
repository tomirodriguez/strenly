...
export type ExerciseGroup = {
  readonly id: string
  readonly orderIndex: number  // UI derives letter from this: 0=A, 1=B, 2=C...
...
export type Series = {
  ...
  readonly tempo: string | null  // 4-char ECCC format, displayed as (3010) in UI
  readonly restSeconds: number | null
}

// UI NOTATION:
// - Intensity uses @: "3x8 @RIR2", "4x6 @75%", "3x10 @120kg"
// - Tempo uses parentheses: "3x8 (3010)", not "3x8 @3010"
```
