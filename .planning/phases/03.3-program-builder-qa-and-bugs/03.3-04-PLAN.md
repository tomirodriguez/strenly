...
Note: Look at how weeksCount creates weeks and follow the same pattern for sessions.
  ...
  <verify>
1. Run `pnpm typecheck` - no errors
2. Create a new program with sessionsCount=3
3. Open the program in editor
4. Verify 3 sessions exist: "Dia 1", "Dia 2", "Dia 3"
5. Create a program with sessionsCount=5
6. Verify 5 sessions are created
  </verify>
