...
- truth: "Superset rows stay physically adjacent - removing from superset moves row outside group, move up/down respects superset boundaries"
  ...
  artifacts: []
  missing:
    - "toggle-superset: reposition row outside superset group when removing"
    - "toggle-superset: reposition row adjacent to group when adding"
    - "reorder-exercise-rows: prevent breaking superset adjacency"
