...
<task type="tdd">
  <name>Task 1: Multi-Part Prescription Notation Parser</name>
  <files>
    packages/contracts/src/programs/prescription.ts
    packages/contracts/src/programs/prescription.test.ts
  </files>
...
```
  ...
  <done>parsePrescriptionToSeries() and formatSeriesToNotation() exist, all tests pass, round-trip works</done>
</task>
