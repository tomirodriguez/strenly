...
Import formatSeriesToNotation from the contracts package for display formatting.
  </action>
  <verify>pnpm typecheck --filter coach-web</verify>
  <done>use-grid-state.ts exists with immer reducer and action handlers</done>
</task>
