...
<task type="tdd">
  <name>Task 1: PrescriptionSeries Domain Entity</name>
  <files>
    packages/core/src/domain/entities/prescription-series.ts
    packages/core/src/domain/entities/prescription-series.test.ts
  </files>
...
pnpm test --filter @strenly/core -- prescription-series.test.ts
...
```
  ...
  <done>prescription-series.ts exists with factory function returning Result, all tests pass</done>
</task>

<task type="tdd">
  <name>Task 2: ExerciseGroup Domain Entity</name>
  <files>
    packages/core/src/domain/entities/exercise-group.ts
    packages/core/src/domain/entities/exercise-group.test.ts
  </files>
...
```bash
# RED: Write tests first, they should fail
pnpm test --filter @strenly/core -- exercise-group.test.ts
...
```
  ...
  <done>exercise-group.ts exists with factory function returning Result, all tests pass</done>
</task>
